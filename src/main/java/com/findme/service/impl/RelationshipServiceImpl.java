...
public class RelationshipServiceImpl implements RelationshipService {
    ...
    @Override
    @Transactional
    public void relationshipProcess(String userFromId, String userToId, String status) throws InternalServerError, BadRequestException{
        ...
        try{
            ...
            relStatus = RelationshipStatus.valueOf(status);
        } catch (IllegalArgumentException e){
            throw new BadRequestException(e.getMessage());
        }

        //Validate user From id
        User userTo = userDAO.findById(userToIdL);
        if(userTo == null)
        ...
        params.put("status", relStatus);
        params.put("userFromId", userFromIdL);
        params.put("userToId", userToIdL);
